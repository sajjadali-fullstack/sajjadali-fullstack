...
|----------|------------|------------|
| [django-quiz-certificates](https://github.com/sajjadali-fullstack/django-quiz-certificates) | A Django web application for taking quizzes with categories, difficulties, scoring, and PDF certificates. |  <img src="https://skillicons.dev/icons?i=python,django,sqlite, <br> html,css,bootstrap" height="20"/> |
