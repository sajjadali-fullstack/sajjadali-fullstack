<!--
<div align="center">
 <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f2027,50:203a43,100:2c5364&height=230&section=header&text=Sajjad%20Ali&fontSize=55&fontColor=ffffff&fontAlignY=38&desc=Senior%20Full-Stack%20Python%20Developer%20%7C%20Django%20%7C%20DRF%20%7C%20AI%20Projects&descAlignY=60&descColor=7ecfff&animation=fadeIn" alt="Sajjad Ali Header" width="100%" />
</div>
 -->
...
|----------|-------------|------------|------|
| 🌐 [My Personal Portfolio](#) | Personal Developer Portfolio showcasing my skills, projects, experience, and journey as a Full-Stack Python Developer. |<img src="https://skillicons.dev/icons?i=html,css,js" height="20"/>  | |
...
(https://genztaskflow.pythonanywhere.com/) |
...
| Project | Description | Tech Stack | Live |
| --- | --- | --- | --- |
| 🌐 [Portfolio](#) | Personal developer portfolio showcasing my skills, projects, experience, and journey as a Full-Stack Python Developer. | HTML • CSS • JavaScript | |
| 📋 [Task Manager](https://github.com/sajjadali-fullstack/genz-taskflow) | A modern Django task management application with user authentication and full CRUD functionality for efficient task organization. | Django • Python • SQLite | |
| 🎓 [Smart Exam Portal](#) | Online examination system with authentication, MCQs, difficulty levels, scoring, results, and admin management. | Django • Python • HTML • CSS | |
| 🕵️ CID Management | Future project — a dedicated CID Management system, thoughtfully designed and built from the ground up. | | |
| 🛒 [GenZKart](https://github.com/sajjadali-fullstack/genz-kart) | Feature-rich e-commerce platform with authentication, product management, and clean Django architecture following industry best practices. | Django • Python • MySQL | 🚧 Coming Soon |
...
<p align="center">
  <img src="https://github-readme-activity-graph-three.vercel.app/graph?username=sajjadali-fullstack&theme=react-dark&hide_border=true&custom_title=Weekly%20Coding%20Activity" />
</p>
